...
TIMELINE_PATCH_SERVICE_PATH = Path(__file__).resolve().parents[1] / "app" / "timeline_patch_service.py"
...
def test_timeline_patch_service_imports_domain_models_only():
    tree = ast.parse(TIMELINE_PATCH_SERVICE_PATH.read_text(encoding="utf-8"), filename=str(TIMELINE_PATCH_SERVICE_PATH))
